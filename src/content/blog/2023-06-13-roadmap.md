...
- :white_check_mark: ~~searching within website (fully local, offline-capable client search using bundled Lunr library)~~
...
- :white_check_mark: ~~Load Markmap and Lunr scripts from local packages rather than external CDNs~~
